...
// Returns the private 'App\Repository\StoreRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/StoreRepository.php';

return $this->privates['App\\Repository\\StoreRepository'] = new \App\Repository\StoreRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

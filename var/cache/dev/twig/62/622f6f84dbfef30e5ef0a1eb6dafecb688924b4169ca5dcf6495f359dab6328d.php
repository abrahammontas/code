...
class __TwigTemplate_af6b18fe237563e8917ad76af3c8d5188d51c1ccf2718382cb6b5d2f7553dacd extends \Twig\Template
{
    private $source;
...
";
    ...
    <p id=\"<?php echo \$view->escape(\$id); ?>_help\" <?php echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$help_attr]); ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$help, [], \$translation_domain) : \$help); ?></p>
<?php endif; ?>
", "@Framework/Form/form_help.html.php", "/Users/hector/Documents/Projects/code/vendor/symfony/framework-bundle/Resources/views/Form/form_help.html.php");
    }
}

...
// Returns the private 'annotated_app_entity_order_api_platform_core_bridge_doctrine_orm_filter_date_filter' shared autowired service.
...
include_once $this->targetDirs[3].'/vendor/api-platform/core/src/Bridge/Doctrine/Common/Filter/DateFilterInterface.php';
include_once $this->targetDirs[3].'/vendor/api-platform/core/src/Bridge/Doctrine/Common/Filter/DateFilterTrait.php';
include_once $this->targetDirs[3].'/vendor/api-platform/core/src/Bridge/Doctrine/Orm/Filter/DateFilter.php';

return $this->privates['annotated_app_entity_order_api_platform_core_bridge_doctrine_orm_filter_date_filter'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\DateFilter(($this->services['doctrine'] ?? $this->getDoctrineService()), NULL, ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())), ['deliveryDate' => 'exclude_null']);
